# gr-rxprocessing_ecological conda recipe
...
4. Install the package into an existing environment
        ...
        conda install --use-local -n <environment_name> gnuradio-rxprocessing_ecological

    or create a new environment that includes the package:

        conda create -n test_env gnuradio-rxprocessing_ecological
